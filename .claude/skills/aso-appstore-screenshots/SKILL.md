...
[ -d "$SKILL_DIR" ] || SKILL_DIR="$HOME/.claude/skills/aso-appstore-screenshots"
...
```bash
SKILL_DIR=".claude/skills/aso-appstore-screenshots"; [ -d "$SKILL_DIR" ] || SKILL_DIR="$HOME/.claude/skills/aso-appstore-screenshots"
